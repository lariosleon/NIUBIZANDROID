...
public class DetailedTestListActivity extends Activity {
	...
	public static final int TEST_CONFIGURATION_STOP_PCL = 15;
	public static final int TEST_CONFIGURATION_CONNECT_PCL = 16;
	public static final int TEST_CONFIGURATION_GET_TIME_ZONE = 17;
	public static final int TEST_CONFIGURATION_SET_TIME_ZONE = 18;
	...
	public static final int	TEST_OFFLINE_JOBS = 504;
	public static final int TEST_UPDATE_REMOTE_CUSTOM = 505;
	...
	public static String[] mStringsUpdate = {
			...
			"U003 - Remote Update",
			"U004 - TMS Parameters",
			"U005 - Remote Update with OfflineJobs",
			"U006 - Remote Update with Parameters"
	};
